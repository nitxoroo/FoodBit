...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-20 flex items-center justify-between md:justify-center gap-7.5 px-5 fixed top-0 z-9999 bg-[#fff9f6] overflow-visible">
      {showSearch && (
        <div className=" w-[90%] h-17.5  fixed top-20 left-[5%] bg-white shadow-xl rounded-lg flex items-center gap-5">
          <div className="flex items-center w-[30%] overflow-hidden gap-2.5 px-2.5 border-r-2 border-gray-400">
            <FaLocationDot size={25} className="text-[#ff4d2d]" />
            <div className=" w-[80%] truncate text-gray-600">Mohali</div>
          </div>
          {/* Search Bar */}
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:block px-3 py-1 rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d]">
          My Orders
        </div>
