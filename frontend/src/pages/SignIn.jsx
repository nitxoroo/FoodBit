    ...
    <div className='min-h-screen flex items-center justify-center p-4' style={{ backgroundColor: bgColor }}>
      <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border border-[${borderColor}] flex flex-col gap-4`}>
        ...
        <div className='text-right'>
          <span className='text-sm text-orange-500 hover:underline cursor-pointer' onClick={() => navigate("/forgot-password")}>Forgot Password?</span>
        </div>

        {/* Sign In Button */}
        <button onClick={handleSignIn} disabled={loading} className={`w-full bg-[#ff4d2d] text-white p-2 rounded-lg transition-colors cursor-pointer hover:bg-[#e64323] disabled:opacity-50 disabled:cursor-not-allowed`}>
        ...
        {/* Sign Up Link */}
        <p className='text-center'>Don't have an account? <span className='text-orange-500 hover:underline cursor-pointer' onClick={() => navigate("/signUp")}>Sign Up</span></p>
